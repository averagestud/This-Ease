...
rf_model = jb.load('model_files/rf_model.pkl')
ensemble_model = jb.load('model_files/ensemble_model.pkl')
lr_model = jb.load('model_files/lr_model.pkl')
svm_model = jb.load('model_files/svm_model.pkl')
mms_scaler = jb.load('model_files/mms.pkl')
ss_scaler = jb.load('model_files/ss.pkl')
...
model_type = st.selectbox("Models", options=['Logistic Regression', 'Random Forest', 'SVM', 'Ensemble'])
